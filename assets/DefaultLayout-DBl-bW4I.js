...
z"/>
</svg>`],K0=["100 100",`<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
M163.483734,137.999939 
	...
	C164.592667,137.961044 164.189102,137.979385 163.483734,137.999939 
z"/>
</svg>`],J0=[{component:J,name:"Luật-AI",to:"/qa",icon:d.jsx(K,{icon:g0,customClassName:"nav-icon"}),badge:{color:"info",text:"NEW"}}],e9=()=>{const t=w2(),r=B1(e=>e.sidebarUnfoldable),i=B1(e=>e.sidebarShow);return d.jsxs(z1,{className:"border-end",colorScheme:"dark",position:"fixed",unfoldable:r,visible:i,onVisibleChange:e=>{t({type:"set",sidebarShow:e})},children:[d.jsxs(S1,{className:"border-bottom",children:[d.jsxs(M1,{to:"/",children:[d.jsx(K,{customClassName:"sidebar-brand-full",icon:Q0,height:32}),d.jsx(K,{customClassName:"sidebar-brand-narrow",icon:K0,height:32})]}),d.jsx(v1,{className:"d-lg-none",dark:!0,onClick:()=>t({type:"set",sidebarShow:!1})})]}),d.jsx(f2,{items:J0}),d.jsx(_1,{className:"border-top d-none d-lg-flex",children:d.jsx(w1,{onClick:()=>t({type:"set",sidebarUnfoldable:!r})})})]})},t9=l.memo(e9),m2=t=>{const{content:r,href:i,name:e}=t,o=e.slice(-1)==="s",n=`https://coreui.io/react/docs/${i}`;return d.jsxs(E1,{color:"info",className:"bg-white",children:[r||`A React ${e} component ${o?"have":"has"} been created as a native React.js version
      of Bootstrap ${e}. ${e} ${o?"are":"is"} delivered with some new features,
      variants, and unique design that matches CoreUI Design System requirements.`,d.jsx("br",{}),d.jsx("br",{}),"For more information please visit our official"," ",d.jsx(s1,{href:n,target:"_blank",children:"documentation of CoreUI Components Library for React.js"}),"."]})};m2.propTypes={content:c.string,href:c.string,name:c.string};const n9=l.memo(m2),v2=t=>{const{href:r,name:i,text:e,...o}=t,n=i?`https://coreui.io/react/docs/components/${i}`:r;return d.jsx("div",{className:"float-end",children:d.jsx(s1,{...o,href:n,rel:"noreferrer noopener",target:"_blank",className:"card-header-action",children:d.jsx("small",{className:"text-body-secondary",children:e||"docs"})})})};v2.propTypes={href:c.string,name:c.string,text:c.string};const s9=l.memo(v2),b2=t=>{const{children:r,href:i,tabContentClassName:e}=t,o=`https://coreui.io/react/docs/${i}`;return d.jsxs("div",{className:"example",children:[d.jsxs(k1,{variant:"underline-border",children:[d.jsx(J,{children:d.jsxs(G,{href:"#",active:!0,children:[d.jsx(K,{icon:y0,className:"me-2"}),"Preview"]})}),d.jsx(J,{children:d.jsxs(G,{href:o,target:"_blank",children:[d.jsx(K,{icon:b0,className:"me-2"}),"Code"]})})]}),d.jsx(O1,{className:`rounded-bottom ${e||""}`,children:d.jsx(T1,{className:"p-3 preview",visible:!0,children:r})})]})};b2.propTypes={children:c.node,href:c.string,tabContentClassName:c.string};const a9=l.memo(b2),r9=()=>d.jsxs("div",{children:[d.jsx(t9,{}),d.jsxs("div",{className:"wrapper d-flex flex-column min-vh-100",children:[d.jsx("div",{className:"body flex-grow-1 mt-4",children:d.jsx(f0,{})}),d.jsx(v0,{})]})]}),l9=Object.freeze(Object.defineProperty({__proto__:null,default:r9},Symbol.toStringTag,{value:"Module"}));export{y1 as C,s9 as D,R as T,D2 as _,a9 as a,g1 as b,i1 as c,k1 as d,J as e,G as f,R2 as g,A2 as h,t1 as i,O1 as j,v1 as k,b1 as l,n9 as m,b0 as n,y0 as o,g0 as p,l9 as q,a1 as u};
